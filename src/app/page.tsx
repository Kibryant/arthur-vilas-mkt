                    ...
                    <div className="flex items-center justify-between h-20">
                        ...
                        <div className="flex items-center gap-3 group cursor-pointer" onClick={() => scrollToSection("hero")}>
                            ...
                            <div className="hidden sm:block">
                                <h2 className={`text-lg font-black tracking-tighter transition-colors ${isScrolled ? "text-gray-900" : "text-white"}`}>
                                    ARTHUR VILAS
                                </h2>
                                <p className={`text-[10px] font-bold uppercase tracking-[0.2em] transition-colors ${isScrolled ? "text-emerald-600" : "text-emerald-400"}`}>
                                    Growth Marketing
                                </p>
                            </div>
                        </div>
                        ...
                        <nav className="hidden lg:flex items-center gap-10">
                            {navItems.map((item) => (
                                <button
                                    ...
                                    className={`relative text-xs font-bold uppercase tracking-widest transition-colors py-2 group ${isScrolled ? "text-gray-600 hover:text-gray-900" : "text-white/80 hover:text-white"
                                        }`}
                                >
                                    {item.name}
                        ...
                        <button
                            ...
                            className={`lg:hidden p-2 rounded-xl transition-all ${isScrolled ? "text-gray-700 hover:bg-gray-100" : "text-white hover:bg-white/10"
                                }`}
            ...
            <section className="py-20 px-4 bg-white" id="resultados">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">Números que falam por si só</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                        {socialLinks.map((link, index) => (
                            ...
                            >
                                <div className="text-center">
                                    <div
                                        className={`inline-flex items-center justify-center w-20 h-20 rounded-2xl mb-6 ${index === 0
                                    ...
                                    <div
                                        className={`inline-flex items-center gap-2 font-semibold ${index === 0 ? "text-green-600" : index === 1 ? "text-blue-600" : "text-pink-600"
